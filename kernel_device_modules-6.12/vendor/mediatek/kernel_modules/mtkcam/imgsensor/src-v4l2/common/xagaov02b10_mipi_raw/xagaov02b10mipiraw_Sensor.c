 ...
 *============================================================================
 ****************************************************************************/
#define PFX "XAGAOV02B10_camera_sensor"
...
#include "xagaov02b10_ana_gain_table.h"
#include "xagaov02b10mipiraw_Sensor.h"
...
static int xagaov02b10_table_write(struct subdrv_ctx *ctx,
		const kal_uint16 *list, u32 len)
{
	u32 i;

	for (i = 0; i < len / 2; i++)
		subdrv_i2c_wr_u8_reg8(ctx, list[i * 2], list[i * 2 + 1]);

	return 0;
}
#define xagaov02b10_table_write_cmos_sensor(...) xagaov02b10_table_write(__VA_ARGS__)
#define LOG_TAG "[xagaov02b10]"
...
static kal_uint32 xagaov02b10_awb_gain(struct subdrv_ctx *ctx,
...
static void xagaov02b10_set_lsc_reg_setting(struct subdrv_ctx *ctx,
...
{
	OV02B10_LOG_INF("+\n");
	xagaov02b10_table_write_cmos_sensor(ctx, xagaov02b10_preview_setting,
		sizeof(xagaov02b10_preview_setting) / sizeof(kal_uint16));
	OV02B10_LOG_INF("-\n");
} /* preview_setting */
		...
		UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_ANA_GAIN_TABLE:
		if ((void *)(uintptr_t) (*(feature_data + 1)) == NULL) {
			*(feature_data + 0) =
				sizeof(xagaov02b10_ana_gain_table);
		} else {
			memcpy((void *)(uintptr_t) (*(feature_data + 1)),
			(void *)xagaov02b10_ana_gain_table,
			sizeof(xagaov02b10_ana_gain_table));
		}
		break;
	...
	case SENSOR_FEATURE_SET_LSC_TBL:
		...
		xagaov02b10_set_lsc_reg_setting(ctx, index, feature_data_16,
...
const struct subdrv_entry xagaov02b10_mipi_raw_entry = {
	.name = "xagaov02b10_mipi_raw",
	.id = XAGAOV02B10_SENSOR_ID,
	.pw_seq = pw_seq,
